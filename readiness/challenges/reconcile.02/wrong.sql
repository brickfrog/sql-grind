...
SELECT ref_id,partner_id,text_points,date_points,quantity_points,category_points,word_points,score,row_number() OVER(PARTITION BY ref_id ORDER BY score DESC)::BIGINT AS rnk FROM pair_scores ORDER BY ref_id,rnk,partner_id;

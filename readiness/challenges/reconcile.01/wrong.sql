...
SELECT ref_id,partner_id,normalized_category,parsed_date,normalized_description FROM candidates WHERE parsed_date IS NOT NULL ORDER BY ref_id,partner_id;
